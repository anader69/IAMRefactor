...
namespace IAMRefactor.Infrastructure.implementation
{
    public class ConfigurationProvider : IConfigurationProvider
    {
        ...
        //public IdentityProviderConfiguration GetIdentityProviderConfigurationObject(string providerName)
        //{
        //    var config = Configuration.GetSection("Saml2");
        //}
        ...
        public X509Certificate2 ServiceProviderSigningCertificate(Saml2Configuration config)
        {
            var certificateDetails = config.ServiceProviderConfiguration.Certificate;
